  ...
  return (
    <main>
      <section className="py-2">
        <div className="max-w-4xl mx-auto px-1 sm:px-6 lg:px-1">
          <div className="text-center mb-3">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white tracking-tight sm:text-5xl md:text-6xl mb-1">
              Go Viral with
